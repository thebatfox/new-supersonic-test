...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white py-12 px-6" style={{backgroundImage: "linear-gradient(hsla(0,0%,100%,0.04) 1px, transparent 1px), linear-gradient(90deg, hsla(0,0%,100%,0.04) 1px, transparent 1px), linear-gradient(hsla(0,0%,100%,0.015) 1px, transparent 1px), linear-gradient(90deg, hsla(0,0%,100%,0.015) 1px, transparent 1px)", backgroundSize: "50px 50px, 50px 50px, 10px 10px, 10px 10px"}}>
